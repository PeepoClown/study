	...
	private :
		class UnsignedFormException : public std::exception
		{
			...
			public :
				...
				virtual ~UnsignedFormException() _NOEXCEPT;
				UnsignedFormException(const std::string &errorMsg);
				UnsignedFormException(const UnsignedFormException &unsignedFormException);

				UnsignedFormException&	operator= (const UnsignedFormException
